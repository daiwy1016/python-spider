...
if __name__ == '__main__':
    ...
    for index in range(400):
        ...
        unlock = bf.find('img',class_='un-lock')
        print(unlock==None)
        if unlock==None :
            free=""
        else:
            free="【收费】"
        # print(type(bf.title.text))
        # print(bf.title.text)
        # if bf.title.text == None:
        #     continue
        
        loglist(base_folder+"91hanman.txt",url + '=' + free+bf.title.text)        
        print(url + '=' + bf.title.text)
