...
if __name__ == '__main__':
    ...
    #定义一组
    manhua_list=['meishubanjiangshu=/mh/xe/65.html','zhenaiqiyue=/mh/xe/66.html','wurendaojihua=/mh/xe/67.html','shengzhigonglue=/mh/xe/68.html','jiqinvyou=/mh/xe/69.html']
