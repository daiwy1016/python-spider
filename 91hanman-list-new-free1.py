...
if __name__ == '__main__':
    ...
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/21=性感的高手们')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/7=手感第三季')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/53=无法自拔的口红胶')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/15=诱惑')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/26=2204号室的事情')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/10=玩火')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/9=脱光光小岛')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/6=手感')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/29=出轨')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/13=性王之路')
