...
if __name__ == '__main__':
    ...
    manhua_list=[]
    # HOME
    manhua_list.append('保镖=/book/17')
    manhua_list.append('xxmh-精灵之子=/book/18')
    manhua_list.append('xxmh-感性变态=/book/19')
    manhua_list.append('xxmh-朋友的妻子=/book/20')
    manhua_list.append('xxmh-我的姐妹=/book/22')
    manhua_list.append('xxmh-大学室友=/book/23')
    manhua_list.append('xxmh-H校园=/book/24')
    # COMPANY
