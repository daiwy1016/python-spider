...
if __name__ == '__main__':
    ...
    #定义一组
    manhua_list=['bennengjuexing=/mh/xe/41.html','furendeliwu=/mh/xe/142.html','zhengrongzhen=/mh/xe/119.html','dianjishaonian=/mh/xe/118.html','maopaihuizhang=/mh/xe/82.html']
