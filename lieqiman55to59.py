...
if __name__ == '__main__':
    ...
    #定义一组
    manhua_list=['pizicangying=/mh/xe/55.html','ouxiangbaobiao=/mh/xe/56.html','muhoushetuan=/mh/xe/57.html','linshijiesu=/mh/xe/58.html','sangshibinansuo=/mh/xe/59.html']
