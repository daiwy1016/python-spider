...
if __name__ == '__main__':
    ...
    #定义一组
    manhua_list=['tadeshijian=/mh/xe/13.html','huiguniangdegegemen=/mh/xe/14.html','bujingyedexiaojiejie=/mh/xe/15.html','chuigui=/mh/xe/16.html','yaojiaohuanma=/mh/xe/17.html']
