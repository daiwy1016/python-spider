...
if __name__ == '__main__':
    ...
    manhua_list=[]
    # HOME
    manhua_list.append('xxmh-电击少年=/book/28')#83 中断 
    manhua_list.append('xxmh-最后的审判=/book/29')
    manhua_list.append('xxmh-狂徒法则=/book/30')
    manhua_list.append('xxmh-不良房东=/book/31')
    manhua_list.append('xxmh-离魂倩女=/book/32')
    manhua_list.append('xxmh-上瘾游戏=/book/33')
    manhua_list.append('xxmh-音频痴女=/book/34')
    manhua_list.append('xxmh-隐忍=/book/35')
    #manhua_list.append('xxmh-挣脱牢笼=/book/36')
    manhua_list.append('xxmh-魔力旅馆=/book/38')
    manhua_list.append('xxmh-金手指=/book/39')
    manhua_list.append('xxmh-月红夜花=/book/40')
    # COMPANY
