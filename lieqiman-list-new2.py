...
if __name__ == '__main__':
    ...
    manhua_list.append('zhengtuolaolong=/mh/xe/123.html')
    manhua_list.append('linghaoshouji=/mh/xe/124.html')
    manhua_list.append('tongbuchuanyue=/mh/xe/125.html')
    manhua_list.append('chashinv=/mh/xe/126.html')
    manhua_list.append('huochexunmeng=/mh/xe/127.html')
    manhua_list.append('quanzhikanhu=/mh/xe/128.html')
    manhua_list.append('qianfucike=/mh/xe/129.html')
