...
if __name__ == '__main__':
    ...
    #定义一组
    manhua_list=['tuimoshi=/mh/xe/50.html','yuanfentiantai=/mh/xe/51.html','jiaminafuchouji=/mh/xe/52.html','jujianuannan=/mh/xe/53.html','womeiyoushuohuang=/mh/xe/54.html']
