...
if __name__ == '__main__':
    ...
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/32=哪里坏坏')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/3=姐姐莲')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/30=老婆回来了')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/39=莉莉丝的救赎')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/28=本能解决师')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/37=DarkSea')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/132=干爹我还要')
    manhua_list.append('https://www.91hanman.com/book/webBookDetail/31=楼凤')
